            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    <span>
                        ...
                        <select id="userrole" name="UserRole" value='Not Selected' class="selectfont">
                ...
                <div class="Gender">
                    ...
                    <span class="label" for="male">&nbsp;Male</span class="label">
                    <input type="radio" name="Gender" id="female" value="Female" <?php if ($re['Gender'] == 'Female') {echo 'Checked';} ?>>
                    <span class="label" for="female">&nbsp;Female</span class="label">
                </div>
                <div class="">
                    <label for="dob" class="label">Date Of Birth</label>
                    <input type="date" name="DateOfBirth" id="dob" value="<?php echo $re['DateOfBirth']; ?>" class="selectfont">
                </div>
                <div class="">
                    <label for="mobile" class="label">Mobile No<sup>*</sup><span id="phoneError" class="error-message"></span></label>
                    <input type="tel" name="MobileNo" id="mobile" maxlength="10" value="<?php echo $re['MobileNo']; ?>" class="selectfont">
                </div>
...
<?php
    ...
    if(isset($_POST['update2'])){    
        ...
        if(mysqli_stmt_execute($stmt)) {
            ...
            ?> <meta http-equiv="refresh" content="0;  URL=employee-data.php" /><?php
        } else {
