    ...
    <head>
        ...
        <script>
            ...
            function download(userId) {
                location.replace('generate_excel_data_tcs.php?userIdtcs=' + userId);
            }

            function closePopup() {
                var popup = document.getElementById('popup');
                popup.style.display = 'none';
                location.replace('project_data_tcs.php');
            }
        </script>
            ...
            <div class="text" >
                            ...
                            <?php
                                ...
                                while (($res = mysqli_fetch_assoc($data))) {
                                    ...
                                    <tr class="tr" >
                                        ...
                                        <td >
                                            <form action="update_project_data_tcs.php" method="post">
                                            ...
                                            <form action="payment_status_tcs.php" method="post">
                ...
                <?php }
                    ...
                    <div class="no_data">
                        ...
                        <div>
                            <p>Want to create project <a href='choose_client_tcs.php'>Click here</a></p>
                        </div>
                    </div>
                <?php }?>
            </div>
