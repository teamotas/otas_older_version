        ...
        <section class="home">
            <?php if ($total != 0) {?>
                <table border="4" >
                    <thead > 
                        <tr>
                            <td colspan="100%"  class="thtr">EMPLOYEE DATA</td>
                        </tr>
                        <tr class="thead">
                    ...
                    <tbody>
                        ...
                        while (($res = mysqli_fetch_assoc($data))) {
                            ...
                            <tr class="tr">
                                <td>'.$srNo.'</td>
                                <td class="tduserphoto"><img src="' .  (!empty($res['emplimage']) && file_exists($res['emplimage']) ? $res['emplimage'] : 'photos/default_image.jpeg') . '" class="tduserimg"></td>
                        ...
                        <tr>
                            <td colspan="100%"  class="tdxl" >
                                <?php
                                    if ($total != 0) {
                                        $_SESSION['fileReady'] = true;
                                        // echo '<button onclick="downloadExcel()" class="exclbtngen">Generate and Download Excel File</button>';
                
                                        echo '<a href="popup.php?Id=' . $adminId . '"><button type="button" class="exclbtngen">Generate and Download Excel File</button></a>';
                                    }
                                ?>
                            </td>
                        </tr>
            ...
            <?php }else{?>
                <div class="no_data">
                    ...
                    <div>
                        <p>Want to create new employee <a href='create_user.php'>Click here</a></p>
                    </div>
                </div>
            <?php }?>
        </section>
