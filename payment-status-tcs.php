...
<html lang="en">
    ...
    <body>
        <section class="home">
                    ...
                    <div class="payment-details ">
                        ...
                        <div class="stage ">
                            ...
                            <div class="pymnt1">
                                ...
                                <input type="number" name="resper" id="resper" class="input" style="width: 35rem;" value="<?php  if(isset($_SESSION['update_pymnt_status1']) ){echo $q22['resPcnt'];}?>">
                            </div>
                        </div>
                    </div>
                    <div class="payment-details ">
            ...
            <script defer src="js/payment-status-tcs.js"></script>
        </section>
    </body>
</html>
<?php
