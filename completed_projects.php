<?php
    ...
    elseif($adminType==='Admin')
    {
        ...
        JOIN stg5pymntdetail stg5 ON stg4.projid=stg5.projid
        JOIN client cl ON prdata.ClientId = cl.ClientId 
        WHERE `Status`='Completed' ORDER BY `prdata`.`projid` ASC";
    }
        ...
        <section class="home">
            <?php if ($total != 0) {?>
                <table border="4">
                    <thead > 
                        <tr>
                            <td colspan="100%"  class="thtr">Completed Project Data</td>
                        </tr>
                        <tr class="thead">
                            ...
                            <th rowspan="2" class="thstyle">Prjocet Duration</th>
                    ...
                    <?php
                        ...
                        while (($res = mysqli_fetch_assoc($data))) {
                            ...
                            <tr class="tr" >
                                ...
                                <td>
                                    <form action="update_project_data.php" method="post">
            ...
            <?php }
                ...
                <div class="no_data">
                    <div><h3> No Completed Project Available  </h3></div>
                </div>
            <?php }?>
        </section>
    </body>
