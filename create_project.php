...
<body >
    <section class="home" >  
        <div class="project-container" >
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="Post" autocomplete="off" enctype="application/x-www-form-urlencoded" >
                ...
                <div class="project-details">
                    ...
                    <div class="inputbox">
                         <span for="expcandcount" class="details"> Exp Candidate Count<!--<sup>*</sup>--></span> 
                        <!-- <input type="text" name="expCandCount" id="expcandcount" class="input"   placeholder="Enter candidate count"> -->
                    ...
                    <div class="inputbox " >
                        ...
                        <div class="project-details">
                            <div class="inputbox ">
                                <span for="AplLivDate" class="details">Application Start <pre class="mmddyy">(mm/dd/yyyy)</pre></span>
                                <input type="date" name="AplLivDate" id="AplLivDate" class="input" >
                            </div>
                            <div class="inputbox "> 
                                <span for="AplLivEndDate" class="details">Application End <pre class="mmddyy">(mm/dd/yyyy)</pre></span>
                                <input type="date" name="AplLivEndDate" id="AplLivEndDate" class="input" >
                            </div>
                        </div>
                    </div> 
                    ...
                    <div class="inputbox ">
                        ...
                        <!-- <div id="cbtShiftContainer" class="input" style="position: relative;">
                            <input type="text" id="selectedCBTs" class="input" readonly placeholder="--CBT Shifts Date-Wise--">
                            <i class='bx bx-chevron-down dropdown-selectCbt'></i>
                        </div>
                        <div class="select-box-cbt">
                            <div class="select-dropdown-cbt" id="cbtShiftOptionsContainer" >
                                
                            </div>
                        </div>     -->
                    </div>
                    <div class="inputbox " id="objmng">
                        <!-- <span for="ObjMngDate" class="details">Objection Mgmt. Schedule</span> -->
                        <div class="project-details">
                            <div class="inputbox ">
                                <span for="ObjMngDateStart" class="details">Obj. Start Date<pre class="mmddyy">(mm/dd/yyyy)</pre></span>
                                <input type="date" name="ObjMngDateStart" id="ObjMngDateStart" class="input" >
                            </div>
                            <div class="inputbox ">
                                <span for="ObjMngDateEnd" class="details">Obj. End Date<pre class="mmddyy">(mm/dd/yyyy)</pre></span> 
        ...
        <script defer src="js/create_project.js"></script>
