<?php
    ...
    if($adminType==='Admin'){
    $sql = "SELECT * FROM employee em, department dp, roles ro  WHERE em.EmployeeId=dp.EmployeeId AND dp.EmployeeId=ro.EmployeeId AND ro.UserRole='Admin'";
        ...
        <section class="home">
            <?php if ($total != 0) {?>
                <table border="4" >
                    <thead > 
                        <tr>
                            <td colspan="100%"  class="thtr">Admin</td>
                        </tr>
                        <tr class="thead">
                    ...
                    <tbody>
                        ...
                        while (($res = mysqli_fetch_assoc($data))) {
                            ...
                            <tr class="tr" >
                                <td>&nbsp;&nbsp;&nbsp;'.$srNo.'</td>
                                <td class="tduserphoto">
                                    <img src="' .  (!empty($res['emplimage']) && file_exists($res['emplimage']) ? $res['emplimage'] : 'photos/default_image.jpeg') . '" class="tduserimg">
                                </td>
