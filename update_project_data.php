            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="Post" autocomplete="off" enctype="application/x-www-form-urlencoded" >
                ...
                <div class="project-details">
                    ...
                    <!-- <div class="inputbox">
                        ...
                        <input type="text" required name="projectID" disabled id="projectID" class="input" value="">
                    </div> -->
                    ...
                    <div class="inputbox">
                        ...
                        <select name="excludingJammerServiceVendor" id="" class="input">
                            ...
                            <option value="TCS" <?php if($q3['otherServiceVendor'] =="TCS"){echo"selected";}?>>TCS</option>
                            <option value="Innovatiview" <?php if($q3['otherServiceVendor'] =="Innovatiview"){echo"selected";}?>>Innovatiview</option>
                        </select>
                    </div>
                    <div class="inputbox">
