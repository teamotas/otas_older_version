<?php
    ...
    elseif($adminType==='Admin')
    {
        ...
        JOIN stg5pymntdetail stg5 ON stg4.projid=stg5.projid
        JOIN client cl ON prdata.ClientId = cl.ClientId
        WHERE `Status`='Ongoing' ORDER BY `prdata`.`projid` ASC";
    }
        ...
        <section class="home">
            <?php if ($total != 0) {?>
                <table border="4">
                    <thead > 
                        <tr>
                            <td colspan="100%"  class="thtr">Ongoing Project Data</td>
                        </tr>
                        <tr class="thead">
            ...
            <?php }
                ...
                <div class="no_data">
                    <div><h3> No Ongoing Project Available </h3></div>
                    &nbsp;&nbsp;
                </div>
            <?php }?>
            </div>
