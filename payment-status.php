...
<!-- Stage 3 -->
                        <div class="stage ">
                            ...
                            <label for="InvAmtRaised" class='details '>Total Raised Invoice Amount (In Rs.)</label>
                                <input type="text" name="InvAmtRaised" readonly id="InvAmtRaised" class="input "   value="<?php  if(isset($_SESSION['update_pymnt_status'])){echo $q22['InvAmtRaised'];}?>" >
                            </div>
                        </div>
<!-- Stage 4 -->
                        <div class="stage ">
...
<!-- Stage 5 -->
                    ...
                    <span >
                        <input type="submit" value="Submit" name="submitpymnt" class="pymn-btn">
                    </span>
                </form>
            </div>
            <script>
            ...
            <script defer src="js/payment-status.js"></script>
        </section>
    </body>
</html>
<?php
